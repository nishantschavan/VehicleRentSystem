            ...
            <div className="mainpage">
                <div className="firsthalf">
                    <div className="content">
                        ...
                        <input type="text" id="textbox" placeholder="Enter wallet ID"/>
                        <input type="text" id="textbox" placeholder="100 units Deposit"/>
                        <div className="btnflex">
                            <button className={bgcolor} onClick={changecolor}>Send</button>
