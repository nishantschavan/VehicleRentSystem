...
const Booknowpage3 = () => {
    ...
    const userstate = useSelector(state => state.User.userData.data);
    const userstateS = useSelector(state => state.User.UserStatus);
    ...
    return (
        <div className="container">
            ...
            {  
                    ...
                    userstate ===`{"message": "Your Trasaction is added to Block 2 as 1 transaction"}` &&
                 <h2 style={{color:'black'}}>successfull</h2> 
